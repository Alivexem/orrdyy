...
$(document).ready(function(){
	...
	$(".slicknav_menu").appendTo(".mainmenu_area_4");
	$(".slicknav_menu").appendTo(".mainmenu_area_5");
	$(".slicknav_menu").appendTo(".mainmenu_area_6");
...
/* header_sticky */
 $(window).on('scroll',function() {
   ...
   if (scroll < 245) {
    ...
    var scroll = $(window).scrollTop();
   if (scroll < 245) {
    $("#header_sticky_4").removeClass("scroll_header_4");
   }else{
    $("#header_sticky_4").addClass("scroll_header_4");
   }
   var scroll = $(window).scrollTop();
   if (scroll < 245) {
    $("#header_sticky_5").removeClass("scroll_header_5");
   }else{
    $("#header_sticky_5").addClass("scroll_header_5");
   }
   var scroll = $(window).scrollTop();
   if (scroll < 245) {
    $("#header_sticky_6").removeClass("scroll_header_6");
   }else{
    $("#header_sticky_6").addClass("scroll_header_6");
   }
  });
